...
if __name__ == '__main__':
    ...
    test_list.appendRow(
        [QStandardItem('nick_1'), QStandardItem('192.198.0.5'), QStandardItem('23544'), QStandardItem('21:38:18')])
    test_list.appendRow(
        [QStandardItem('nick_2'), QStandardItem('192.198.0.8'), QStandardItem('33245'), QStandardItem('21:42:34')])
